...
| [`models/housegan`](api/models/housegan/) | House-GAN | `transformers` | House-GAN floorplan vectorized | convert locally ([REPRODUCING.md](https://github.com/creative-graphic-design/design-generators/blob/main/models/housegan/REPRODUCING.md)) |
