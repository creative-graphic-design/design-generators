...
design-generators ports layout, poster, and graphic-design generation research repositories into packages shaped by [`🤗 transformers`](https://huggingface.co/docs/transformers/index), [`🧨 diffusers`](https://huggingface.co/docs/diffusers/index), and [`🤖 pydantic-ai`](https://ai.pydantic.dev/). Converted weights and prompt configurations load through a consistent public inference schema.
