...
The repository-wide methodology for S0-S5 training reproduction, topology guards, dataset coverage, seed policy, and evidence recording is defined in [`docs/training-reproduction.md`](../../docs/training-reproduction.md).
