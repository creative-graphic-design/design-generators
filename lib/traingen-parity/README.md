...
Install from outside the workspace with pip's direct-reference subdirectory form. Install [`traingen`](https://github.com/creative-graphic-design/design-generators/tree/main/lib/traingen) alongside this package when using the shared training CLI.
