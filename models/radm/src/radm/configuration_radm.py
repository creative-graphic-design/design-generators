...
RADM_DIFFUSION_STATE_KEYS: Final[frozenset[str]] = frozenset(
    {
        "betas",
        "alphas_cumprod",
        "alphas_cumprod_prev",
...
class RADMConfig(ConfigMixin):
    ...
    Args:
        ...
        num_heads: Number of repeated proposal refinement blocks.
        num_attention_heads: Proposal self-attention head count.
        dim_feedforward: Proposal feed-forward hidden dimension.
        num_dynamic: Number of dynamic-convolution projections.
        dim_dynamic: Intermediate dynamic-convolution dimension.
        num_cls: Number of repeated classification projection layers.
        num_reg: Number of repeated box-regression projection layers.
        roi_resolution: ROIAlign output resolution.
        roi_sampling_ratio: ROIAlign sampling ratio.
        with_vtram: Whether visual-textual relation features are enabled.
        with_gram: Whether geometric relation features are enabled.
        deep_supervision: Whether intermediate proposal heads are returned.
        backbone_depth: ResNet backbone depth.
        backbone_freeze_at: Number of initial ResNet stages to freeze.
    ...
    def __init__(
        ...
        *,
        ...
        self.backbone_freeze_at = int(backbone_freeze_at)
