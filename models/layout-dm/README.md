...
Package-local training reproduction is tracked in [TRAINING.md](models/layout-dm/TRAINING.md); S0-S4 scaffolding is in place and S5 full-run statistical comparison is pending.
