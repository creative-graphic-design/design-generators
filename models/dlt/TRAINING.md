...
| Magazine | not run | `not-yet-run (see artifact summary)` | not yet run | not yet run | not yet run | Pending support for the Magazine dataset and polygon/train-only handling; see [standing checklist issue #60](<https://github.com/creative-graphic-design/design-generators/issues/60>). |
